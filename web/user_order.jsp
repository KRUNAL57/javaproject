				...
				<table class="table table-bordered table-hover table-responsive">
                                    <%
                                        ...
                                        if(null==session.getAttribute("userObject")){
                                            ...
                                            UserMaster um = (UserMaster)session.getAttribute("userObject");
                                            List<OrderMaster> lstCart = OrderDAO.getOrderList(um);
                                            for(int z=0;z<lstCart.size();z++){
                                                OrderMaster c =  lstCart.get(z);
                                                out.print("<tr>");
                                                out.print("<td>"+c.getOrderId()+"</td>");
                                                out.print("<td>"+c.getOrderDate()+"</td>");
                                                out.print("<td>"+c.getAddress()+"</td>");
                                                out.print("<td>"+c.getTotalPrice()+"</td>");
                                                out.print("</tr>"); 
                                            }
